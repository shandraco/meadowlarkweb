      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-20 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-sm font-normal leading-relaxed max-w-xs mb-2">
              An estate orchard and cidery east of Wichita, Kansas. Every cider made from fruit grown right here.
            </p>
            <p className="text-xs font-normal text-paper/40">Tom & Gina Brown · Founders</p>

            <div className="mt-8">
              <p className="text-xs tracking-widest uppercase font-normal text-wheat mb-3">Seasonal updates</p>
              <form className="flex gap-0 max-w-sm">
                <input
                  type="email"
                  placeholder="your@email.com"
                  className="flex-1 bg-meadow border border-paper/20 text-paper placeholder:text-paper/30 px-4 py-3 text-sm font-normal outline-none focus:border-wheat/60 transition-colors"
                />
                <button
                  type="submit"
                  className="px-5 py-3 bg-wheat text-ink text-xs tracking-widest uppercase font-normal hover:bg-wheat-light transition-colors shrink-0"
                >
                  Join
                </button>
              </form>
          ...
          <div className="md:col-span-2">
            <p className="text-xs tracking-widest uppercase font-normal text-wheat mb-6">Explore</p>
            <nav className="flex flex-col gap-4">
              {[
                ...
                <Link key={l.href} href={l.href} className="text-sm font-normal hover:text-paper transition-colors">
                  {l.label}
                </Link>
              ))}
            </nav>
          ...
          <div className="md:col-span-4">
            <p className="text-xs tracking-widest uppercase font-normal text-wheat mb-6">Find Us</p>
            <address className="not-italic text-sm font-normal leading-loose">
              11249 SW 160th St
              <br />
              Rose Hill, KS 67133
              <br />
        ...
        <div className="border-t border-paper/10 pt-8 flex flex-col md:flex-row justify-between gap-4 text-xs font-normal text-paper/75">
