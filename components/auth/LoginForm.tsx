    ...
    <section className="min-h-screen flex items-center justify-center px-6 py-24 bg-paper">
      <div className="w-full max-w-sm">
        ...
        <form action={formAction} className="space-y-4">
          ...
          {state.error && <p className="text-sm text-sunset font-light">{state.error}</p>}
        ...
        <Link
          href="/"
          className="block text-center text-xs tracking-widest uppercase font-light text-stone hover:text-meadow transition-colors mt-8"
        >
          ← Back to site
        </Link>
      </div>
