  ...
  return (
    <section className="pt-36 pb-28 min-h-[60vh]">
      <div className="max-w-xl mx-auto px-6 md:px-12">
        ...
        {gift.message && (
          <div className="bg-wheat-dark border-l-4 border-sunflower p-4 mb-8 italic text-ink font-normal">
            &ldquo;{gift.message}&rdquo;
            <p className="not-italic text-xs text-stone mt-2">— {gift.buyer_name}</p>
          </div>
        )}
        <ClaimForm token={token} />
        <p className="text-xs text-stone font-normal text-center mt-6">
